...
- [基础概念（Fundamentals）](docs/basic-concepts.md) — 14 个术语：LLM、Token、上下文窗口、涌现能力、推理模型……
- [模型架构（Model Architecture）](docs/model-architecture.md) — 13 个术语：Transformer、注意力机制、GQA、MoE、分词器……
- [训练（Training）](docs/training.md) — 15 个术语：预训练、RLHF、DPO、GRPO、合成数据……
...
- [Prompt 工程（Prompt Engineering）](docs/prompt-engineering.md) — 13 个术语：Prompt、System Prompt、Zero-shot / One-shot / Few-shot、CoT……
- [RAG 与检索（RAG and Retrieval）](docs/rag-retrieval.md) — 13 个术语：RAG、Embedding、向量数据库、重排序、GraphRAG……
- [智能体（Agents）](docs/agents.md) — 12 个术语：Agent、工具调用、MCP、ReAct、计算机使用……
- [多模态（Multimodal）](docs/multimodal.md) — 12 个术语：VLM、文生图、文生视频、ASR、TTS、语音克隆……
- [评估与基准（Evaluation and Benchmarks）](docs/evaluation-benchmarks.md) — 10 个术语：MMLU、HumanEval、困惑度、基准污染……
- [安全与对齐（Safety and Alignment）](docs/safety-alignment.md) — 12 个术语：对齐、越狱、护栏、红队测试、深度伪造……
